...
public class MoExpressionUtils {
     ...
     */
    @Nullable
    public static PsiTryStatement getParentOfTry(PsiElement element) {
        while (!(element instanceof PsiTryStatement)) {
            if (element == null) {
                return null;
            }
            element = element.getParent();
     ...
     * 向上查找到当前的if gudong
     * @param element PsiElement
     * @return PsiIfStatement | null
     */
    @Nullable
    public static PsiIfStatement getParentOfIf(PsiElement element) {
        while (!(element instanceof PsiIfStatement)) {
            if (element == null) {
                return null;
            }
            element = element.getParent();
    ...
    /**
     * 向上查找到当前的while gudong
     * @param element PsiElement
     * @return PsiWhileStatement | null
     */
    @Nullable
    public static PsiWhileStatement getParentOfWhile(PsiElement element) {
        while (!(element instanceof PsiWhileStatement)) {
            if (element == null) {
                return null;
            }
            element = element.getParent();
        }
        return (PsiWhileStatement)element;
    }
    /**
     * 向上查找到当前的if gudong
     * @param element PsiElement
     ...
     */
    @Nullable
    public static PsiStatement getParentOfIfOrWhile(PsiElement element) {
        while (!(element instanceof PsiIfStatement || element instanceof PsiWhileStatement)) {
            if (element == null) {
                return null;
            }
            element = element.getParent();
     ...
     */
    @NotNull
    public static List<PsiReference> getReferenceOnMethodScope(PsiReference reference, int maxOffset) {
